#!/usr/bin/env python3
"""
sync-skills-to-claude: Copies selected skills to .claude/agents/ for Claude Dev integration.
...
def main():
    parser = argparse.ArgumentParser(description="Sync skills to .claude/agents")
